            ...
            <div class="modal-content"
                ...
                <form action="{{ route('red.routes.static.ipv4.store') }}" method="POST">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-dark text-white border-secondary" name="interface"
                                    required placeholder="ej. lan">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" style="color: var(--text-soft);">Objetivo</label>
                                <input type="text" class="form-control bg-dark text-white border-secondary" name="target"
                                    required placeholder="Dirección IP o red (ej. 192.168.2.0)">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" style="color: var(--text-soft);">Máscara de red IPv4</label>
                                <input type="text" class="form-control bg-dark text-white border-secondary" name="netmask"
                                    placeholder="ej. 255.255.255.0">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" style="color: var(--text-soft);">Puerta de enlace IPv4</label>
                                <input type="text" class="form-control bg-dark text-white border-secondary" name="gateway"
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control bg-dark text-white border-secondary" name="metric"
                                    placeholder="0">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" style="color: var(--text-soft);">MTU</label>
                                <input type="number" class="form-control bg-dark text-white border-secondary" name="mtu"
                                    placeholder="1500">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-dark text-white border-secondary" name="table"
                                    placeholder="ej. main">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" style="color: var(--text-soft);">Dirección de origen</label>
                                <input type="text" class="form-control bg-dark text-white border-secondary" name="source"
                                    placeholder="Automático">
                            </div>
                        </div>

                        <div class="form-check mt-3">
                            <input class="form-check-input bg-dark border-secondary" type="checkbox" value="1" name="onlink"
                                id="onlink">
                    ...
                    <div class="modal-footer" style="border-top: 1px solid var(--border-soft); padding: 16px 24px;">
                        <button type="button" class="btn text-white fw-bold" data-bs-dismiss="modal"
